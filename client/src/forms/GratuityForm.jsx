...
import { useSubmitGratuityFormMutation } from '../redux/slices/gratuityFormApiSlice'
...
const GratuityForm = () => {
  ...
  const [submitGratuityForm] = useSubmitGratuityFormMutation()
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await submitGratuityForm({
        ...formData,
  ...
  return (
    <>
      <p className="title-text">Gratuity Pay</p>
